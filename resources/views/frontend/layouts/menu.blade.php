                            ...
                            <ul class="wsus_menu_cat_droapdown">
                                ...
                                <li><a href="#">{{ $subCategory->name }} <i class="{{count($subCategory->childCategories) > 0 ? 'fas fa-angle-right' : ''}}"></i></a>
                                    ...
                                    <ul class="wsus__sub_category">
                                        @foreach ($subCategory->childCategories as $childCtegory)
                                        <li><a href="#">{{ $childCtegory->name }}</a> </li>
                                        @endforeach
                                    </ul>
                                    @endif
                                </li>
            ...
            <div class="wsus__mobile_menu_main_menu">
                <div class="accordion accordion-flush" id="accordionFlushExample">
                    <ul class="wsus_mobile_menu_category">
                        ...
                        @foreach ($categories as $category)
                        <li><a href="#" class="{{(count($category->subCategories) > 0) ? 'accordion-button' : '' }} collapsed" data-bs-toggle="collapse" data-bs-target="#flush-collapseThreew-{{ $loop->index }}" aria-expanded="false" aria-controls="flush-collapseThreew-{{ $loop->index }}"><i class="{{ $category->icon }}"></i> {{ $category->name }}</a>
                            @if(count($category->subCategories) > 0)
