<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ setActive(['admin.dashboard']) }}"><a class="nav-link" href="{{ route('admin.dashboard') }}">Dashboard</a></li>
            ...
            <li class="dropdown {{ setActive([
                ...
                <ul class="dropdown-menu">
                    <li class="{{ setActive(['admin.category.*']) }}"><a class="nav-link {{ setActive(['admin.category.*']) }}" href="{{ route('admin.category.index') }}">Category</a></li>
